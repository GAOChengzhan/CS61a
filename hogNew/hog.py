...
def play(strategy0, strategy1, update,
    ...
    # BEGIN PROBLEM 5
    scoreList=[score0, score1]
    playerID=0
    while scoreList[0]<goal and scoreList[1]<goal:
        #decide numrolls
        if playerID==0:
            numrolls=strategy0(scoreList[playerID],scoreList[other(playerID)])
        else:
            numrolls=strategy1(scoreList[playerID],scoreList[other(playerID)])
        #four or six sided
        scoreList[playerID]=update(numrolls,scoreList[playerID],scoreList[other(playerID)],dice=dice)
        playerID=1-playerID

    [score0, score1]=scoreList
    # END PROBLEM 5
...
def is_always_roll(strategy, goal=GOAL):
    ...
    for i in range(goal):
        for j in range(goal):
            sameNum.add(strategy(i,j))
    return len(sameNum)==1
    # END PROBLEM 7
...
def square_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    res=square_update(0,score,opponent_score)-score
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    #averaged_roll_dice = make_averaged(roll_dice, 1000000)
    #averaged_roll_dice(6,six_sided)
    averageRoll6=8.693695
    roll0=square_update(0,score,opponent_score)
    if roll0>100 or roll0-score>averageRoll6:
        return 0
    elif square_update(1,score,opponent_score)>100:
        return 1
    elif square_update(2,score,opponent_score)>100:
        return 2
    else:
