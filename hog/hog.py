...
def play(strategy0, strategy1, goal=GOAL_SCORE):
    ...
    "*** YOUR CODE HERE ***"
    scoreList=[score, opponent_score]
    playerID=0
    while score<100 and opponent_score<100:
        ...
        #four or six sided
        n_sided=select_dice(scoreList[0],scoreList[1])
        score=take_turn(numrolls,scoreList[other(playerID)],dice=n_sided)
        scoreList[playerID]+=score
        if scoreList[playerID]<=100 and (scoreList[playerID]==2*scoreList[other(playerID)] or \
            2*scoreList[playerID]==scoreList[other(playerID)]):
            scoreList[playerID],scoreList[other(playerID)]=\
                scoreList[other(playerID)],scoreList[playerID]
        #take_turn
        playerID=1-playerID
